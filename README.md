...
- Clean code: Chia các hàm trong khối hàm vòng trong các thuật toán thành các hàm thư viện, hàm main chỉ chưa lời gọi đến các hàm thư viện và hàm nhập/xuất dữ liệu 
